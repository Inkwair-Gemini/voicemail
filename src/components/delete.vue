<template>
  <div class="container">
    <div class="main">
        ...
        <el-table :data="deleteList.filter(data => !search || data.title.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
            ...
            <el-table-column align="right">
              ...
              <template slot-scope="scope">
                <el-button class="recover" size="mini" @click="handleReover(scope.$index, scope.row)">
